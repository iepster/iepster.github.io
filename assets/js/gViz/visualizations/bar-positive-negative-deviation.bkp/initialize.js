...
module.exports = function() {
  ...
  let validate = function(step) {
    switch (step) {
      ...
      case 'positiveRange': return true;
      case 'negativeRange': return true;
    ...
    if (validate(step)) {
      ...
      switch (step) {
        ...
        case 'run':
          ...
          _var.data = data;
          _var.positiveRange = positiveRange;
          _var.negativeRange = negativeRange;
  ...
  ['_id','_var','animation','container','colors','data','height','margin','width', 'positiveRange', 'negativeRange'].forEach(function(key) {
