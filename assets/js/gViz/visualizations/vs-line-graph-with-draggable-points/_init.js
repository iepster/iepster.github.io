...
module.exports = function () {
  ...
  ['_id', '_var', 'action', 'animation', 'container', 'colors', 'data', 'margin','onHoverBetween','onHover','onClick','onDragStart','onDragEnd'].forEach(function (key) {
